					...
					<div class="hero">
						...
						<div class="   ">
							<h4
								...
								Shared ID is an ID under which an action performed cannot be
								attributed to a specific individual. This includes, but is not
								limited to, cases where the password is known by more than one
								person at a time or over the course of time, and can be used to
								authenticate to an interactive session resulting in loss of
								individual accountability. <br>New to Compliance Dashboard
								? Check out the Tool User's Guide.
							</h4>
							<div class="login-app-icons">
								<a href="javascript:void(0);" class="btn btn-danger btn-sm">Tool
									Guide</a>
							</div>
						</div>
